...
OaksLabHS:
	...
	db OAKS_LAB, $05, SHOW ; HS_EEVEE_BALL
	db OAKS_LAB, $06, HIDE ; HS_OAKS_LAB_OAK_1
	db OAKS_LAB, $07, SHOW ; HS_POKEDEX_1
	db OAKS_LAB, $08, SHOW ; HS_POKEDEX_2
	db OAKS_LAB, $09, HIDE ; HS_OAKS_LAB_OAK_2
ViridianGymHS:
