...
OaksLabHS:
	...
	db OAKS_LAB, $02, SHOW ; HS_EEVEE_BALL
	db OAKS_LAB, $03, HIDE ; HS_OAKS_LAB_OAK_1
	db OAKS_LAB, $04, SHOW ; HS_POKEDEX_1
	db OAKS_LAB, $05, SHOW ; HS_POKEDEX_2
	db OAKS_LAB, $06, HIDE ; HS_OAKS_LAB_OAK_2
	db OAKS_LAB, $0A, SHOW ; HS_STARTER_BALL_1
	db OAKS_LAB, $0B, SHOW ; HS_STARTER_BALL_2
	db OAKS_LAB, $0C, SHOW ; HS_STARTER_BALL_3
ViridianGymHS:
...
PokemonTower7FHS:
	...
	db POKEMON_TOWER_7F, $05, HIDE ;HS_POKEMON_TOWER_7F_JESSIE
	db POKEMON_TOWER_7F, $06, HIDE ;HS_POKEMON_TOWER_7F_JAMES
MrFujisHouseHS:
	db MR_FUJIS_HOUSE, $05, HIDE
CeladonMansionRoofHouseHS:
	db CELADON_MANSION_ROOF_HOUSE, $02, SHOW
GameCornerHS:
	db GAME_CORNER, $08, SHOW
WardensHouseHS:
...
MtMoonB2FHS:
	...
	db MT_MOON_B2F, $07, HIDE;james
	db MT_MOON_B2F, $08, SHOW;fossil
	db MT_MOON_B2F, $09, SHOW;fossil
	db MT_MOON_B2F, $0A, SHOW;HP_UP
	db MT_MOON_B2F, $0B, SHOW;TM_MEGA_PUNCH
SSAnne2FHS:
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, $03, HIDE ;HS_ROCKET_HIDEOUT_B4F_JAMES
	db ROCKET_HIDEOUT_B4F, $04, HIDE ;HS_ROCKET_HIDEOUT_B4F_JESSIE
...
SilphCo11FHS:
	...
	db SILPH_CO_11F, $06, SHOW ;HS_SILPH_CO_11F_JAMES
	db SILPH_CO_11F, $04, SHOW ;HS_SILPH_CO_11F_2
	db SILPH_CO_11F, $05, SHOW ;HS_SILPH_CO_11F_3
	db SILPH_CO_11F, $07, SHOW ;HS_SILPH_CO_11F_JESSIE
UnusedMapF4HS:
