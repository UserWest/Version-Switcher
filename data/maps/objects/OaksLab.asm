...
OaksLab_Object:
	...
	object_event  0,  0, SPRITE_NONE, RED_OR_BLUE, STAY, NONE, 1 ; filler
	...
	object_event  7,  3, SPRITE_POKE_BALL, RED_OR_BLUE, STAY, NONE, 11 ; middle ball
	object_event  8,  3, SPRITE_POKE_BALL, RED_OR_BLUE, STAY, NONE, 12 ; right ball
	object_event  0,  0, SPRITE_NONE, YELLOW_VERSION, STAY, NONE, 10 ; filler
	object_event  0,  0, SPRITE_NONE, YELLOW_VERSION, STAY, NONE, 11 ; filler
	object_event  0,  0, SPRITE_NONE, YELLOW_VERSION, STAY, NONE, 12 ; filler
