PewterCity_Object:
	...
	def_object_events
	object_event  8, 15, SPRITE_COOLTRAINER_F, ANY_VERSION, STAY, NONE, 1 ; person
	object_event 17, 25, SPRITE_COOLTRAINER_M, ANY_VERSION, STAY, NONE, 2 ; person
	object_event 27, 17, SPRITE_SUPER_NERD, ANY_VERSION, STAY, NONE, 3 ; person
	object_event 26, 25, SPRITE_SUPER_NERD, ANY_VERSION, WALK, LEFT_RIGHT, 4 ; person
	object_event 35, 16, SPRITE_YOUNGSTER, ANY_VERSION, STAY, DOWN, 5 ; person
