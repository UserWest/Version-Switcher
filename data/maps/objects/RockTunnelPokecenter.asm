RockTunnelPokecenter_Object:
	...
	object_event  7,  3, SPRITE_GENTLEMAN, YELLOW_VERSION, STAY, DOWN, 2 ; person
	object_event  7,  3, SPRITE_GENTLEMAN, RED_OR_BLUE, WALK, LEFT_RIGHT, 2 ; person
	object_event  2,  5, SPRITE_FISHER, ANY_VERSION, STAY, NONE, 3 ; person
