CeladonMart3F_Object:
	...
	def_object_events
	object_event 16,  5, SPRITE_CLERK, ANY_VERSION, STAY, NONE, 1 ; person
	object_event 11,  6, SPRITE_GAMEBOY_KID, ANY_VERSION, STAY, RIGHT, 2 ; person
	object_event  7,  2, SPRITE_GAMEBOY_KID, ANY_VERSION, STAY, DOWN, 3 ; person
	object_event  8,  2, SPRITE_GAMEBOY_KID, ANY_VERSION, STAY, DOWN, 4 ; person
	object_event  2,  5, SPRITE_LITTLE_BOY, ANY_VERSION, STAY, UP, 5 ; person
