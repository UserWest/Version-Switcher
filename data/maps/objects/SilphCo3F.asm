SilphCo3F_Object:
	...
	def_object_events
	object_event 24,  8, SPRITE_SILPH_WORKER, ANY_VERSION, STAY, NONE, 1 ; person
	object_event 20,  7, SPRITE_ROCKET, ANY_VERSION, STAY, LEFT, 2, OPP_ROCKET, 25
	object_event  7,  9, SPRITE_SCIENTIST, ANY_VERSION, STAY, DOWN, 3, OPP_SCIENTIST, 4
	object_event  8,  5, SPRITE_POKE_BALL, ANY_VERSION, STAY, NONE, 4, HYPER_POTION
