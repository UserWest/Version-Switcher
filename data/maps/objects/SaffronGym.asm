SaffronGym_Object:
	...
	def_object_events
	object_event  9,  8, SPRITE_COOLTRAINER_F, YELLOW_VERSION, STAY, DOWN, 1, OPP_SABRINA, 1
	object_event  9,  8, SPRITE_GIRL, RED_OR_BLUE, STAY, DOWN, 1, OPP_SABRINA, 2
	object_event 10,  1, SPRITE_CHANNELER, ANY_VERSION, STAY, DOWN, 2, OPP_CHANNELER, 22
	object_event 17,  1, SPRITE_YOUNGSTER, ANY_VERSION, STAY, DOWN, 3, OPP_PSYCHIC_TR, 1
	object_event  3,  7, SPRITE_CHANNELER, ANY_VERSION, STAY, DOWN, 4, OPP_CHANNELER, 23
	object_event 17,  7, SPRITE_YOUNGSTER, ANY_VERSION, STAY, DOWN, 5, OPP_PSYCHIC_TR, 2
	object_event  3, 13, SPRITE_CHANNELER, ANY_VERSION, STAY, DOWN, 6, OPP_CHANNELER, 24
	object_event 17, 13, SPRITE_YOUNGSTER, ANY_VERSION, STAY, DOWN, 7, OPP_PSYCHIC_TR, 3
	object_event  3,  1, SPRITE_YOUNGSTER, ANY_VERSION, STAY, DOWN, 8, OPP_PSYCHIC_TR, 4
	object_event 10, 15, SPRITE_GYM_GUIDE, ANY_VERSION, STAY, DOWN, 9 ; person
