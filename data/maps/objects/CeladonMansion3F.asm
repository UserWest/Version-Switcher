CeladonMansion3F_Object:
	...
	def_object_events
	object_event  0,  4, SPRITE_BIKE_SHOP_CLERK, ANY_VERSION, STAY, UP, 1 ; person
	object_event  3,  4, SPRITE_CLERK, ANY_VERSION, STAY, UP, 2 ; person
	object_event  0,  7, SPRITE_SUPER_NERD, ANY_VERSION, STAY, UP, 3 ; person
	object_event  2,  3, SPRITE_SILPH_WORKER, ANY_VERSION, STAY, NONE, 4 ; person
