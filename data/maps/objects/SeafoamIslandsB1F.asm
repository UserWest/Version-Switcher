SeafoamIslandsB1F_Object:
	...
	def_object_events
	object_event 17,  6, SPRITE_BOULDER, ANY_VERSION, STAY, BOULDER_MOVEMENT_BYTE_2, 1 ; person
	object_event 22,  6, SPRITE_BOULDER, ANY_VERSION, STAY, BOULDER_MOVEMENT_BYTE_2, 2 ; person
