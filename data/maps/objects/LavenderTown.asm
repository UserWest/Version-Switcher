LavenderTown_Object:
	...
	def_object_events
	object_event 15,  9, SPRITE_LITTLE_GIRL, ANY_VERSION, WALK, ANY_DIR, 1 ; person
	object_event  9, 10, SPRITE_COOLTRAINER_M, ANY_VERSION, STAY, NONE, 2 ; person
	object_event  8,  7, SPRITE_SUPER_NERD, ANY_VERSION, WALK, LEFT_RIGHT, 3 ; person
