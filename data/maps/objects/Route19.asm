Route19_Object:
	...
	def_object_events
	object_event  9,  7, SPRITE_COOLTRAINER_M, YELLOW_VERSION, STAY, RIGHT, 1, OPP_SWIMMER, 2
	object_event 12,  9, SPRITE_COOLTRAINER_M, YELLOW_VERSION, STAY, LEFT, 2, OPP_SWIMMER, 3
	...
	object_event  9, 13, SPRITE_SWIMMER, YELLOW_VERSION, STAY, DOWN, 6, OPP_SWIMMER, 7
