SeafoamIslandsB4F_Object:
	...
	def_object_events
	object_event  4, 15, SPRITE_BOULDER, ANY_VERSION, STAY, NONE, 1 ; person
	object_event  5, 15, SPRITE_BOULDER, ANY_VERSION, STAY, NONE, 2 ; person
	object_event  6,  1, SPRITE_BIRD, ANY_VERSION, STAY, DOWN, 3, ARTICUNO, 50
