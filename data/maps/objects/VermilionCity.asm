VermilionCity_Object:
	...
	def_object_events
	object_event 19,  7, SPRITE_COOLTRAINER_F, YELLOW_VERSION, WALK, LEFT_RIGHT, 1 ; person
	object_event 19,  7, SPRITE_BEAUTY, RED_OR_BLUE, WALK, LEFT_RIGHT, 1 ; person
	object_event 14,  6, SPRITE_GAMBLER, ANY_VERSION, STAY, NONE, 2 ; person
	object_event 19, 30, SPRITE_SAILOR, ANY_VERSION, STAY, UP, 3 ; person
	object_event 30,  7, SPRITE_GAMBLER, ANY_VERSION, STAY, NONE, 4 ; person
	object_event 29,  9, SPRITE_MONSTER, ANY_VERSION, WALK, UP_DOWN, 5 ; person
	object_event 25, 27, SPRITE_SAILOR, ANY_VERSION, WALK, LEFT_RIGHT, 6 ; person
	object_event 19, 15, SPRITE_OFFICER_JENNY, YELLOW_VERSION, STAY, NONE, 7 ; person
