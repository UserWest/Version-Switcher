...
PalPacket_Red:            PAL_SET PAL_RED_VERSION, PAL_GREEN_VERSION, PAL_GREEN_VERSION, PAL_RED_VERSION
PalPacket_Blue:           PAL_SET PAL_BLUE_VERSION, PAL_RED_VERSION, PAL_RED_VERSION, PAL_BLUE_VERSION
