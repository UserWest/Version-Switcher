...
; entries correspond to PAL_* constants
	...
	RGB 31,31,31, 31,16,16, 18,07,07, 00,00,00 ; PAL_RED_VERSION
	RGB 31,31,31, 12,20,31, 00,00,31, 00,00,00 ; PAL_BLUE_VERSION
	RGB 31,31,31, 15,31,06, 00,12,24, 00,00,00 ; PAL_GREEN_VERSION
...
; entries correspond to PAL_* constants
	...
	RGB 31,31,31, 31,16,16, 18,07,07, 00,00,00 ; PAL_RED_VERSION
	RGB 31,31,31, 12,20,31, 00,00,31, 00,00,00 ; PAL_BLUE_VERSION
	RGB 31,31,31, 15,31,06, 00,16,00, 00,00,00 ; PAL_GREEN_VERSION
	assert_table_length NUM_SGB_PALS
