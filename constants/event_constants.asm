...
; Lavender Town events
	...
	const_skip
	const EVENT_BEAT_POKEMONTOWER_7_JESSIE_AND_JAMES
	const EVENT_POKEMONTOWER_7_PLAYER_LOCATION
	const_skip 4
...
; Mt. Moon events
	...
	const EVENT_BEAT_MT_MOON_3_JESSIE_AND_JAMES	 
...
; Rocket Hideout events
	...
	const_skip 13
	const EVENT_6A0
	const EVENT_BEAT_ROCKET_HIDEOUT_4_JESSIE_AND_JAMES
	...
	const EVENT_ROCKET_HIDEOUT_4_PLAYER_LOCATION
...
; Silph Co. events
	...
	const EVENT_782
	const_skip
	const EVENT_BEAT_SILPH_CO_11F_JESSIE_AND_JAMES
	const_skip 3
