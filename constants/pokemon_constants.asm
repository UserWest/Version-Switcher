...
DEF STARTER_CHARMANDER EQU CHARMANDER
DEF STARTER_SQUIRTLE   EQU SQUIRTLE
DEF STARTER_BULBASAUR  EQU BULBASAUR

; rival starters
DEF RIVAL_STARTER_JOLTEON    EQU 1
DEF RIVAL_STARTER_FLAREON    EQU 2
DEF RIVAL_STARTER_VAPOREON   EQU 3
DEF RIVAL_STARTER_SQUIRTLE   EQU 4
DEF RIVAL_STARTER_BULBASAUR  EQU 5
DEF RIVAL_STARTER_CHARMANDER EQU 6
